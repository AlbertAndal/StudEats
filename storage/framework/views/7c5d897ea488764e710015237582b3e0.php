...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white shadow rounded-lg mb-8">
        ...
        <div class="p-6">
            <form method="GET" action="<?php echo e(route('recipes.index')); ?>" class="space-y-6" id="recipe-search-form">
                <!-- Primary Search Row -->
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="relative">
                            <input type="text" 
                                   id="search" 
                                   name="search" 
                                   class="block w-full pl-10 pr-10 py-3 border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 sm:text-sm transition-all duration-200 <?php echo e(request('search') ? 'bg-green-50 border-green-300' : ''); ?>"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="cuisine_type" class="block text-sm font-medium text-gray-700 mb-2">
                            ...
                            <?php if(request('cuisine_type')): ?>
                                <span class="ml-1 px-2 py-0.5 text-xs font-medium bg-blue-100 text-blue-800 rounded-full"><?php echo e(request('cuisine_type')); ?></span>
                            <?php endif; ?>
                        </label>
                        <div class="relative">
                            <select id="cuisine_type" 
                                    name="cuisine_type" 
                                    class="block w-full pl-10 pr-10 py-3 border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm appearance-none transition-all duration-200 <?php echo e(request('cuisine_type') ? 'bg-blue-50 border-blue-300' : ''); ?>">
                                <option value="">All Cuisines</option>
                                <option value="Filipino" <?php echo e(request('cuisine_type') == 'Filipino' ? 'selected' : ''); ?>>🇵🇭 Filipino</option>
                                <option value="Asian" <?php echo e(request('cuisine_type') == 'Asian' ? 'selected' : ''); ?>>🥢 Asian</option>
                                <option value="Western" <?php echo e(request('cuisine_type') == 'Western' ? 'selected' : ''); ?>>🍕 Western</option>
                                <option value="Mediterranean" <?php echo e(request('cuisine_type') == 'Mediterranean' ? 'selected' : ''); ?>>🫒 Mediterranean</option>
                                <option value="Mexican" <?php echo e(request('cuisine_type') == 'Mexican' ? 'selected' : ''); ?>>🌮 Mexican</option>
                                <option value="Indian" <?php echo e(request('cuisine_type') == 'Indian' ? 'selected' : ''); ?>>🍛 Indian</option>
                            </select>
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945"/>
                    ...
                    <div>
                        <label for="max_cost" class="block text-sm font-medium text-gray-700 mb-2">
                            ...
                            Max Cost (₱)
                            <?php if(request('max_cost')): ?>
                                <span class="ml-1 px-2 py-0.5 text-xs font-medium bg-purple-100 text-purple-800 rounded-full">Under ₱<?php echo e(request('max_cost')); ?></span>
                            <?php endif; ?>
                        </label>
                        <div class="relative">
                            <input type="number" 
                                   ...
                                   min="0" 
                                   step="10"
                                   class="block w-full pl-10 pr-16 py-3 border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 sm:text-sm transition-all duration-200 <?php echo e(request('max_cost') ? 'bg-purple-50 border-purple-300' : ''); ?>"
                                   placeholder="Enter maximum cost..."
                                   value="<?php echo e(request('max_cost')); ?>"
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pt-4 border-t border-gray-200">
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <?php if(request()->hasAny(['search', 'cuisine_type', 'max_cost'])): ?>
                            ...
                            <div class="flex flex-wrap items-center gap-2">
                                ...
                                <?php if(request('search')): ?>
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                        Search: "<?php echo e(Str::limit(request('search'), 20)); ?>"
                                        <a href="<?php echo e(request()->fullUrlWithQuery(['search' => null])); ?>" class="ml-1 text-green-600 hover:text-green-800">×</a>
                                    </span>
                                <?php endif; ?>
                                <?php if(request('cuisine_type')): ?>
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                        <?php echo e(request('cuisine_type')); ?>

                                        <a href="<?php echo e(request()->fullUrlWithQuery(['cuisine_type' => null])); ?>" class="ml-1 text-blue-600 hover:text-blue-800">×</a>
                                    </span>
                                <?php endif; ?>
                                <?php if(request('max_cost')): ?>
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                        Under ₱<?php echo e(request('max_cost')); ?>

                                        <a href="<?php echo e(request()->fullUrlWithQuery(['max_cost' => null])); ?>" class="ml-1 text-purple-600 hover:text-purple-800">×</a>
                                    </span>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                    ...
                    <div class="flex items-center text-sm text-gray-500 bg-gray-50 px-3 py-2 rounded-lg">
                        ...
                        <strong><?php echo e(number_format($meals->total())); ?></strong> recipes found
                    </div>
                </div>
            </form>
        </div>
                ...
                <div class="bg-white shadow rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <div class="aspect-w-16 aspect-h-9 bg-gray-100">
                        <?php if($meal->image_url): ?>
                            <img src="<?php echo e($meal->image_url); ?>" alt="<?php echo e($meal->name); ?>" class="w-full h-48 object-cover" loading="lazy">
                        <?php else: ?>
                    ...
                    <div class="p-4">
                        <div class="flex items-start justify-between mb-2">
                            <h3 class="font-semibold text-gray-900 text-lg"><?php echo e($meal->name); ?></h3>
                            <span class="text-sm font-medium text-green-600">₱<?php echo e($meal->cost); ?></span>
                        </div>
                        
                        <p class="text-sm text-gray-600 mb-3"><?php echo e(Str::limit($meal->description, 80)); ?></p>
                        
                        <div class="flex items-center justify-between mb-3">
                            <div class="flex items-center space-x-4 text-sm text-gray-500">
                                <span><?php echo e($meal->nutritionalInfo->calories ?? 'N/A'); ?> cal</span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\StudEats\resources\views/recipes/index.blade.php ENDPATH**/ ?>