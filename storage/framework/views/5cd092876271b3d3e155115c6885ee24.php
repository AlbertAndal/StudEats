                                    ...
                                    <div class="flex items-start justify-between">
                                        <div class="flex-1">
                                            ...
                                            <div class="flex items-center space-x-2 mt-1">
                                                ...
                                                <span class="text-xs text-gray-500">₱<?php echo e(number_format($displayCost, 2)); ?></span>
                                            </div>
                                        </div>
            ...
            <div class="bg-white shadow rounded-lg">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div class="text-center">
                            <div class="text-2xl font-bold text-purple-600"><?php echo e(number_format($totalCalories)); ?> cal</div>
