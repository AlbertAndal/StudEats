    ...
    <div class="mb-6 bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow p-6" aria-label="Daily budget usage" role="region">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="text-right">
                <div class="text-2xl font-bold text-gray-900">₱<?php echo e(number_format($totalCost, 2)); ?></div>
                <div class="text-xs text-gray-500">of ₱<?php echo e(number_format($dailyBudget, 2)); ?></div>
            </div>
        </div>
        
        <?php $pctWidth = (int)$budgetPct; ?>
        <div class="relative">
            <div class="h-3 w-full rounded-full bg-gray-100 overflow-hidden shadow-inner" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="<?php echo e($pctWidth); ?>" aria-label="Budget used <?php echo e($pctWidth); ?> percent">
                <div class="h-full <?php echo e($budgetBarColor); ?> transition-all duration-500 rounded-full" data-pct="<?php echo e($pctWidth); ?>"></div>
            </div>
            <div class="flex items-center justify-between mt-2">
                <span class="text-xs font-medium text-gray-600"><?php echo e($pctWidth); ?>% used</span>
                <span class="text-xs font-semibold <?php echo e($remainingClass); ?>">
                    <?php if($remaining > 0): ?>
                        <span class="inline-flex items-center gap-1">
                            <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            </svg>
                            ₱<?php echo e(number_format($remaining, 2)); ?> remaining
                        </span>
                    <?php else: ?>
                        <span class="inline-flex items-center gap-1">
                            <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            Over budget by ₱<?php echo e(number_format(abs($remaining), 2)); ?>
                                ...
                                <div class="mt-auto">
                                    ...
                                    <a href="<?php echo e(route('recipes.show', $mealPlan->meal)); ?>" 
                                       class="flex-1 flex items-center justify-center px-3 py-2 text-xs font-medium text-green-700 bg-green-50 rounded-md hover:bg-green-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-300">
                                        <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'book-open','class' => 'w-4 h-4 mr-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'book-open','class' => 'w-4 h-4 mr-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
                                    ...
                                    <button type="button" 
                                            onclick="showRemoveMealModal('<?php echo e($mealPlan->id); ?>', '<?php echo e($mealPlan->meal->name); ?>', '<?php echo e($mealPlan->meal_type); ?>', '<?php echo e($selectedDate->format('M j, Y')); ?>')" 
