            ...
            <div class="flex items-center">
                <div class="p-3 bg-green-100 rounded-lg">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo e(number_format($stats['active'])); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo e(number_format($stats['suspended'])); ?></p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white shadow rounded-lg p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e(number_format($stats['admins'])); ?></p>
                </div>
            </div>
        </div>
        </div>
            ...
            <form method="GET" class="flex flex-wrap gap-4">
                    ...
                    <div class="w-48">
                        ...
                        <select name="status" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            <option value="" <?php echo e(request('status') === '' ? 'selected' : ''); ?>>All Status</option>
                    ...
                    <div class="flex items-end gap-3">
                        ...
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-6 py-2 rounded-lg">
                            Clear
                        </a>
                    </div>
                </form>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <?php if(!$user->is_active && $user->suspended_reason): ?>
                                        <div class="text-xs text-gray-500 mt-1" title="<?php echo e($user->suspended_reason); ?>">
                                            <?php echo e(Str::limit($user->suspended_reason, 30)); ?>
                                    ...
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <?php if($user->id !== auth()->id()): ?>
                                            <?php if($user->is_active): ?>
                                                <button onclick="showSuspendModal('<?php echo e($user->id); ?>')" 
                                            ...
                                            <?php else: ?>
                                                <button onclick="showActivateModal('<?php echo e($user->id); ?>')" 
                                            ...
                                            <?php if($user->role !== 'super_admin'): ?>
                                                <button onclick="showDeleteModal('<?php echo e($user->id); ?>', '<?php echo e($user->name); ?>')" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\StudEats\resources\views/admin/users/index.blade.php ENDPATH**/ ?>