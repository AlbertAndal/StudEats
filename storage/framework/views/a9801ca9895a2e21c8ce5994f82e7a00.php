...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.loading-button','data' => ['onclick' => 'location.reload()','variant' => 'secondary','size' => 'sm','loadingText' => 'Refreshing...','loadingType' => 'spinner','class' => 'border border-gray-300']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['onclick' => 'location.reload()','variant' => 'secondary','size' => 'sm','loadingText' => 'Refreshing...','loadingType' => 'spinner','class' => 'border border-gray-300']); ?>
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <?php if (isset($component)) { $__componentOriginal5167d322754b2071326efbd818afaac3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5167d322754b2071326efbd818afaac3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.loading-button','data' => ['onclick' => 'refreshSystemHealth()','variant' => 'secondary','size' => 'sm','loadingText' => 'Refreshing...','loadingType' => 'spinner','class' => 'border border-gray-300']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('loading-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['onclick' => 'refreshSystemHealth()','variant' => 'secondary','size' => 'sm','loadingText' => 'Refreshing...','loadingType' => 'spinner','class' => 'border border-gray-300']); ?>
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
                            </svg>
                            Refresh
                            ...
                            <?php $__currentLoopData = $topMeals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                    <div class="flex items-center min-w-0">
                                        ...
                                        <?php endif; ?>
                                        <div class="min-w-0">
                                            <h4 class="font-medium text-gray-900 text-sm truncate"><?php echo e($meal->name ?? 'Unnamed Meal'); ?></h4>
                                    ...
                                    <div class="flex items-center gap-3 flex-shrink-0">
                                        <div class="text-center">
                                            <div class="text-sm font-bold text-gray-900"><?php echo e($meal->meal_plans_count ?? 0); ?></div>
