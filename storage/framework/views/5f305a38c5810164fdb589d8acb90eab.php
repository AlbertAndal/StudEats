    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center space-x-1">
                ...
                <!-- Security Monitor -->
                <a href="<?php echo e(route('admin.security-monitor.index')); ?>"
                   class="group inline-flex items-center px-3 py-2 border-b-2 font-medium transition-colors duration-200 <?php echo e(request()->routeIs('admin.security-monitor.*') ? 'border-blue-500 text-blue-600 bg-blue-50' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'); ?>">
...
</script><?php /**PATH /home/runner/work/StudEats/StudEats/resources/views/admin/partials/header.blade.php ENDPATH**/ ?>