                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="date" id="scheduled_date" name="scheduled_date" required
                                           class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm transition-all duration-200 <?php $__errorArgs = ['scheduled_date'];
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                ...
                                <?php $__currentLoopData = $mealTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <label class="relative block <?php echo e($isExisting ? 'cursor-not-allowed opacity-60' : 'cursor-pointer'); ?> group">
                                        <input type="radio" name="meal_type" value="<?php echo e($type); ?>" 
                                               class="sr-only peer" 
                                               data-suggested-time="<?php echo e($details['time']); ?>"
                                               <?php echo e(request('meal_type') == $type ? 'checked' : ''); ?>

                                               <?php echo e($isExisting ? 'disabled' : ''); ?> required>
                                        ...
                                        <div class="meal-type-card relative border-2 rounded-lg p-4 text-center transition-all duration-200 peer-disabled:opacity-60
                                                    <?php echo e($isExisting ? 'border-red-300 bg-red-50 opacity-60' : 'border-gray-200 hover:shadow-md'); ?>

                                                    <?php if(!$isExisting): ?>
                                                        <?php if($type === 'breakfast'): ?>
                                                            hover:border-yellow-300
                                                            <?php echo e(request('meal_type') == $type ? 'border-yellow-500 bg-yellow-50 ring-2 ring-yellow-200 shadow-lg' : ''); ?>

                                                        <?php elseif($type === 'lunch'): ?>
                                                            hover:border-orange-300
                                                            <?php echo e(request('meal_type') == $type ? 'border-orange-500 bg-orange-50 ring-2 ring-orange-200 shadow-lg' : ''); ?>

                                                        <?php elseif($type === 'dinner'): ?>
                                                            hover:border-purple-300
                                                            <?php echo e(request('meal_type') == $type ? 'border-purple-500 bg-purple-50 ring-2 ring-purple-200 shadow-lg' : ''); ?>

                                                        <?php elseif($type === 'snack'): ?>
                                                            hover:border-green-300
                                                            <?php echo e(request('meal_type') == $type ? 'border-green-500 bg-green-50 ring-2 ring-green-200 shadow-lg' : ''); ?>

                                                        <?php endif; ?>
                                                    <?php endif; ?>" 
                                             data-meal-type="<?php echo e($type); ?>">
                                            <div class="text-3xl mb-2"><?php echo e($details['icon']); ?></div>
                                            <div class="meal-type-label text-sm font-semibold
                                                        <?php echo e($isExisting ? 'text-red-700' : 'text-gray-700'); ?>

                                                        <?php if(!$isExisting && request('meal_type') == $type): ?>
                                                            <?php if($type === 'breakfast'): ?>
                                                                text-yellow-700
                                                            <?php elseif($type === 'lunch'): ?>
                                                                text-orange-700
                                                            ...
                                                            <?php elseif($type === 'snack'): ?>
                                                                text-green-700
                                                            <?php endif; ?>
                                                        <?php endif; ?>"><?php echo e($details['label']); ?></div>
                                            <div class="meal-type-time text-xs mt-1
                                                        <?php echo e($isExisting ? 'text-red-600' : 'text-gray-500'); ?>
                                                        ...
                                                        <?php if(!$isExisting && request('meal_type') == $type): ?>
                                                            ...
                                                            <?php endif; ?>
                                                        <?php endif; ?>">
                                                <?php echo e($isExisting ? 'Already scheduled' : $details['time']); ?>
                                        ...
                                        <?php else: ?>
                                            ...
                                            ?>
                                            <div class="absolute -top-2 -right-2 w-7 h-7 <?php echo e($checkmarkBg); ?> rounded-full shadow-lg border-2 border-white z-10 hidden peer-checked:flex items-center justify-center opacity-0 peer-checked:opacity-100 transition-opacity duration-200">
                                                <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.loading-button','data' => ['href' => ''.e(route('meal-plans.index')).'','variant' => 'secondary','size' => 'sm','loadingText' => 'Loading...','loadingType' => 'spinner','class' => 'border border-gray-300']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('meal-plans.index')).'','variant' => 'secondary','size' => 'sm','loadingText' => 'Loading...','loadingType' => 'spinner','class' => 'border border-gray-300']); ?>
                            ...
                            <div>
                                <h2 class="text-lg font-semibold text-gray-900 flex items-center">
                                    ...
                                    <?php if(request('meal_type')): ?>
                                        ...
                                        ?>
                                        <span class="ml-2 inline-flex items-center px-3 py-1 rounded-full text-sm font-medium <?php echo e($filterInfo['color']); ?>">
                                            <span class="mr-1"><?php echo e($filterInfo['icon']); ?></span>
                                            <span class="capitalize"><?php echo e($selectedType); ?> only</span>
                                        </span>
                                    <?php endif; ?>
                                </h2>
                                <p class="text-sm text-gray-600 mt-1">
                                    <?php if(request('meal_type')): ?>
                                        Showing meals suitable for <?php echo e(request('meal_type')); ?>. Select a different meal type above to see other options.
                                    <?php else: ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                                <?php $__currentLoopData = $meals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="group border-2 border-gray-200 rounded-lg p-4 cursor-pointer hover:border-green-400 hover:shadow-lg transition-all duration-300 meal-option bg-white hover:bg-gradient-to-br hover:from-green-50 hover:to-white"
                                         ...
                                         data-meal-cost="₱<?php echo e(number_format($displayCost, 2)); ?>"
                                        ...
                                        <div class="relative mb-3">
                                            <?php if($meal->image_path): ?>
                                                <div class="w-full h-32 bg-gray-100 rounded-md overflow-hidden group-hover:shadow-md transition-shadow duration-300">
                                                    <img src="<?php echo e(asset('storage/' . $meal->image_path)); ?>" 
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <div class="flex items-center justify-center gap-2 mb-1">
                                                    <div class="inline-flex items-center px-2 py-0.5 bg-gray-100 group-hover:bg-green-100 rounded-full text-xs font-medium text-gray-600 group-hover:text-green-700 transition-colors duration-300">
                                                        <span class="capitalize"><?php echo e($meal->cuisine_type); ?></span>
                                                    </div>
                                                    <?php
                                                        $mealTypeColors = [
                                                    ...
                                                    ?>
                                                    <div class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium transition-colors duration-300 <?php echo e($colorClass); ?>">
                                                        <span class="mr-1"><?php echo e($icon); ?></span>
                                                        <span class="capitalize"><?php echo e($meal->meal_type); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <p class="text-xs text-gray-600 text-center line-clamp-2 leading-relaxed px-1">
                                                <?php echo e(Str::limit($meal->description, 80)); ?>
                                                ...
                                                <div class="grid grid-cols-2 gap-4 text-center">
                                                    ...
                                                    <div class="space-y-0.5">
                                                        ...
                                                        <?php if(isset($bmiStatus) && $bmiStatus['calorie_multiplier'] != 1): ?>
                                                            ...
                                                            ?>
                                                            <div class="text-xs font-bold text-orange-600"><?php echo e($adjustedCalories > 0 ? $adjustedCalories : '300'); ?></div>
                                                            <div class="text-xs text-orange-500">cal</div>
                                                        <?php else: ?>
                                                            <div class="text-xs font-bold text-orange-600"><?php echo e($meal->nutritionalInfo->calories ?? '300'); ?></div>
                                                            <div class="text-xs text-orange-500">cal</div>
                                                        <?php endif; ?>
                                                    </div>
                                                    ...
                                                    <div class="space-y-0.5">
                                                        ...
                                                        <div class="text-xs font-bold text-blue-600"><?php echo e($meal->prep_time ?? '30'); ?></div>
            ...
            <div class="sticky top-8 space-y-6">
                ...
                <div class="bg-white shadow rounded-lg">
                    ...
                    <div class="p-6 space-y-3">
                        <?php if (isset($component)) { $__componentOriginal5167d322754b2071326efbd818afaac3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5167d322754b2071326efbd818afaac3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.loading-button','data' => ['href' => ''.e(route('recipes.index')).'','variant' => 'secondary','size' => 'sm','loadingText' => 'Loading...','loadingType' => 'spinner','class' => 'w-full bg-gray-50 hover:bg-gray-100']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('loading-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('recipes.index')).'','variant' => 'secondary','size' => 'sm','loadingText' => 'Loading...','loadingType' => 'spinner','class' => 'w-full bg-gray-50 hover:bg-gray-100']); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginal5167d322754b2071326efbd818afaac3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5167d322754b2071326efbd818afaac3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.loading-button','data' => ['href' => ''.e(route('meal-plans.index')).'','variant' => 'secondary','size' => 'sm','loadingText' => 'Loading...','loadingType' => 'spinner','class' => 'w-full bg-gray-50 hover:bg-gray-100']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('loading-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('meal-plans.index')).'','variant' => 'secondary','size' => 'sm','loadingText' => 'Loading...','loadingType' => 'spinner','class' => 'w-full bg-gray-50 hover:bg-gray-100']); ?>
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-lg font-bold text-green-600"><?php echo e(number_format($bmiStatus['daily_calories'])); ?> cal</span>
                            </div>
                                    ...
                                    <div>
                                        ...
                                        <?php if($bmiStatus['calorie_multiplier'] != 1): ?>
                                            <p class="text-xs text-blue-600 mt-1">
                                                Meal calories are <?php echo e($bmiStatus['calorie_multiplier'] > 1 ? 'increased' : 'reduced'); ?> by <?php echo e(round(abs(($bmiStatus['calorie_multiplier'] - 1) * 100))); ?>% for your health goals.
                                            </p>
                                        <?php endif; ?>
                                    </div>
                                </div>
