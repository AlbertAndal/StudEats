    ...
    <div class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mb-6">
            <div class="flex justify-between items-start mb-4">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 mb-2"><?php echo e($recipe->name); ?></h1>
                    <p class="text-gray-600 leading-relaxed"><?php echo e($recipe->description); ?></p>
                </div>
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1"><?php echo e(count(is_array($recipe->recipe->ingredients) ? $recipe->recipe->ingredients : explode("\n", $recipe->recipe->ingredients))); ?> ingredients total</p>
                        </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $totalPrice = 0; ?>
                            <?php $__currentLoopData = is_array($recipe->recipe->ingredients) ? $recipe->recipe->ingredients : explode("\n", $recipe->recipe->ingredients); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $ingredient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <?php if($name): ?>
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="py-3 px-4 text-sm text-gray-500"><?php echo e($loop->iteration); ?></td>
                                        <td class="py-3 px-4">
                                            <span class="text-base font-medium text-gray-900"><?php echo e($name); ?></span>
                                        </td>
                                        ...
                                        <td class="py-3 px-4 text-right">
                                            <?php if($price): ?>
                                                <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-yellow-100 text-yellow-700">
                                                    ₱<?php echo e(number_format($ingredientTotal, 2)); ?>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="py-3 px-4 text-right font-bold text-green-700 bg-green-50">₱<?php echo e(number_format($totalPrice, 2)); ?></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
                    ...
                    <div class="p-6">
                        ...
                        <?php if(count($steps) > 1): ?>
                            <ol class="space-y-4">
                                <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($step): ?>
                                    <li class="flex gap-4">
                                        <span class="flex-shrink-0 w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center font-semibold text-sm"><?php echo e($index + 1); ?></span>
                                        <p class="text-gray-700 leading-relaxed"><?php echo e($step); ?></p>
                                    </li>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ol>
                        <?php else: ?>
                            <div class="prose max-w-none">
                                <div class="text-gray-700 leading-relaxed whitespace-pre-wrap"><?php echo e($recipe->recipe->instructions); ?></div>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                    ...
                    <div class="p-6 space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="text-center p-4 bg-orange-50 rounded-lg">
                                <p class="text-2xl font-bold text-orange-600"><?php echo e(number_format($recipe->nutritionalInfo->fats, 1)); ?>g</p>
                        ...
                        <div class="mt-6 border-t pt-4">
                            <div class="flex flex-col gap-2">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="font-semibold text-gray-900"><?php echo e($recipe->calories); ?> kcal</span>
                                </div>
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="font-semibold text-green-700">₱<?php echo e(number_format($totalPrice ?? $recipe->cost, 2)); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="mt-8 text-sm text-gray-500 flex justify-between">
            <span>Created: <?php echo e($recipe->created_at->format('F j, Y \a\t g:i A')); ?></span>
            <span>Last Updated: <?php echo e($recipe->updated_at->format('F j, Y \a\t g:i A')); ?></span>
        </div>
    </div>
