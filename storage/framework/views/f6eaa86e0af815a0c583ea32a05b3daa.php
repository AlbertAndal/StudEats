...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        ...
        <div class="flex items-start gap-3">
            ...
            <div class="flex-1 min-w-0">
                ...
                <p class="text-sm text-orange-700 mt-1">
                    Please verify <span class="font-medium"><?php echo e($user->email); ?></span> to unlock all features.
                </p>
                <div class="mt-3">
    ...
    <form id="profile-form" action="<?php echo e(route('profile.update')); ?>" method="POST" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <?php echo csrf_field(); ?>
                ...
                <div class="p-4 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" required
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all <?php $__errorArgs = ['name'];
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="email" id="email" name="email" required
                                   class="w-full px-4 py-2.5 pr-10 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> <?php if(!$user->email_verified_at): ?> border-orange-300 bg-orange-50 <?php endif; ?>"
                                   value="<?php echo e(old('email', $user->email)); ?>"
                                   placeholder="Enter your email address">
                            <?php if(!$user->email_verified_at): ?>
                                <div class="absolute inset-y-0 right-0 pr-2 flex items-center">
                                    <a href="<?php echo e(route('email.verify.form')); ?>" class="text-xs text-orange-600 hover:text-orange-700" title="Verify Email">⚠</a>
                                </div>
                            <?php endif; ?>
                        </div>
                        <?php if(!$user->email_verified_at): ?>
                            <p class="mt-1 text-xs text-orange-600">Email needs verification • <a href="<?php echo e(route('email.verify.form')); ?>" class="underline hover:no-underline">Verify now</a></p>
                        <?php else: ?>
                            <p class="mt-1 text-xs text-green-600">✓ Verified <?php echo e($user->email_verified_at->format('M d, Y')); ?></p>
                        <?php endif; ?>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="number" id="age" name="age" min="13" max="120"
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="gender" name="gender"
                                    class="w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all <?php $__errorArgs = ['gender'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select id="timezone" name="timezone"
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all <?php $__errorArgs = ['timezone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="Asia/Manila" <?php echo e(old('timezone', $user->timezone) == 'Asia/Manila' ? 'selected' : ''); ?>>Asia/Manila (PHT)</option>
                        ...
                        <div>
                            ...
                            <div class="flex space-x-1">
                                <input type="number" id="height" name="height" min="100" max="250" step="0.1"
                                       class="flex-1 px-3 py-2.5 border border-gray-300 rounded-l-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all <?php $__errorArgs = ['height'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
                        ...
                        <div>
                            ...
                            <div class="flex space-x-1">
                                <input type="number" id="weight" name="weight" min="30" max="300" step="0.1"
                                       class="flex-1 px-3 py-2.5 border border-gray-300 rounded-l-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all <?php $__errorArgs = ['weight'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <?php $__currentLoopData = $activityLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="relative flex items-center p-2 border rounded-md cursor-pointer hover:bg-gray-50 transition-colors <?php echo e(old('activity_level', $user->activity_level) == $value ? 'bg-green-50 border-green-500' : 'border-gray-300'); ?>">
                                    ...
                                    <span class="mr-2"><?php echo e($info[1]); ?></span>
                                    <span class="text-sm font-medium text-gray-900 peer-checked:text-green-700"><?php echo e($info[0]); ?></span>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="daily_budget" name="daily_budget" min="100" max="2000" step="10"
                                   class="w-full pl-7 pr-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all <?php $__errorArgs = ['daily_budget'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="dietary_preferences" 
                                  rows="4"
                                  class="w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all <?php $__errorArgs = ['dietary_preferences'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                  placeholder="E.g., I'm vegetarian, avoid spicy food, prefer low-carb meals, allergic to peanuts, etc."><?php echo e(old('dietary_preferences', is_string($user->dietary_preferences) ? $user->dietary_preferences : '')); ?></textarea>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (resendButton) {
            resendButton.addEventListener('click', function(e) {
                ...
                // Submit resend form
                if (form) {
                    form.action = '<?php echo e(route("email.verify.resend")); ?>';
                    form.method = 'POST';
                    form.submit();
                }
        ...
        if (profileForm && emailInput) {
            ...
            const originalEmail = '<?php echo e($user->email); ?>';
            const isVerified = <?php echo e($user->email_verified_at ? 'true' : 'false'); ?>;
        ...
        document.addEventListener('keydown', function(e) {
            ...
            if ((e.ctrlKey || e.metaKey) && e.key === 'v' && !isVerified) {
                e.preventDefault();
                window.location.href = '<?php echo e(route("email.verify.form")); ?>';
            }
        });
