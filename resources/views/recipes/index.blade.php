        ...
        <div class="flex items-center justify-between">
            ...
            @if($recipes->count() > 0)
                <div class="text-sm text-gray-500">
                    <span class="font-semibold text-gray-900">{{ $recipes->total() }}</span> recipes available
                </div>
            @endif
        </div>
    </x-slot>
                    ...
                    <form method="GET" action="{{ route('recipes.index') }}" class="space-y-4">
                        ...
                        @if(request('search') || request('cuisine_type'))
                            <div class="flex items-center justify-between pt-2 border-t border-gray-200">
                                ...
                                <a href="{{ route('recipes.index') }}" class="text-xs text-gray-600 hover:text-gray-900 font-medium">
                                    Clear all
                                </a>
                            </div>
                        @endif
            ...
            @else
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
                    <div class="p-12 text-center">
                        ...
                        @if(request('search') || request('cuisine_type'))
                            <a href="{{ route('recipes.index') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-semibold rounded-lg shadow-sm hover:shadow-md transition-all">
