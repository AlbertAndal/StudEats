    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="rounded-md bg-blue-50 border-2 border-blue-400 p-4">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800">📧 Verification Code Sent</h3>
                    <div class="mt-2 text-sm text-blue-700">
                        <p class="mb-2">A 6-digit verification code has been sent to your email address.</p>
                        <p class="text-xs text-blue-600">💡 Please check your inbox (and spam folder) for the verification code</p>
                        <p class="text-xs text-blue-600 mt-1">⏰ The code will expire in 5 minutes</p>
                    </div>
                </div>
            </div>
        </div>
