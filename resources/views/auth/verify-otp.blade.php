...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        @if (session('dev_otp_code'))
            <div class="rounded-md bg-yellow-50 border-2 border-yellow-400 p-4">
                <div class="flex">
                    <div class="flex-shrink-0">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-yellow-800">Development/Testing Mode</h3>
                        <div class="mt-2 text-sm text-yellow-700">
                            <p class="mb-2">Email delivery might be unavailable. Use this code:</p>
                            <p class="font-mono font-bold text-2xl text-yellow-900 bg-yellow-100 px-4 py-2 rounded text-center">
                                {{ session('dev_otp_code') }}
                            </p>
                            <p class="mt-2 text-xs">Expires: {{ session('dev_otp_expires') }}</p>
                        </div>
                    </div>
                </div>
            </div>
