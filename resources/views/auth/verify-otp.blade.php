...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        @if (session('dev_otp_code'))
            <div class="rounded-md bg-blue-50 border-2 border-blue-400 p-4">
                <div class="flex">
                    <div class="flex-shrink-0">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-blue-800">📧 Email Verification Code</h3>
                        <div class="mt-2 text-sm text-blue-700">
                            <p class="mb-2">Check your email or use this code below:</p>
                            <div class="bg-white border-2 border-blue-300 rounded-lg p-4 my-3">
                                <p class="font-mono font-bold text-3xl text-blue-900 text-center tracking-widest">
                                    {{ session('dev_otp_code') }}
                                </p>
                            </div>
                            <p class="text-xs text-blue-600">⏰ Valid until: {{ \Carbon\Carbon::parse(session('dev_otp_expires'))->format('g:i A') }}</p>
                            <p class="text-xs text-blue-600 mt-1">💡 This code has also been sent to your email</p>
                        </div>
                    </div>
                </div>
            </div>
