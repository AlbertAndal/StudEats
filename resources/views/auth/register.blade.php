                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-1">
                                ...
                                <input id="name" name="name" type="text" autocomplete="name" required value="{{ old('name') }}" placeholder="Jane Doe"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-1">
                                ...
                                <input id="age" name="age" type="number" min="13" max="120" value="{{ old('age') }}" placeholder="18"
                                       class="w-full rounded-md border border-input bg-background px-3 py-2 text-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 @error('age') border-destructive @enderror">
                                @error('age')<p class="text-xs text-destructive mt-1">{{ $message }}</p>@enderror
                            </div>
                            <div class="space-y-1">
                                <label for="daily_budget" class="text-sm font-medium">Daily Budget (₱)</label>
                                <input id="daily_budget" name="daily_budget" type="number" min="100" max="1000" step="10" value="{{ old('daily_budget') }}" placeholder="300"
                                       class="w-full rounded-md border border-input bg-background px-3 py-2 text-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 @error('daily_budget') border-destructive @enderror">
                                <p class="text-xs text-muted-foreground">Recommended: ₱270–₱390</p>
                                @error('daily_budget')<p class="text-xs text-destructive mt-1">{{ $message }}</p>@enderror
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3 pt-4 border-t border-border">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-1">
                                ...
                                <select id="gender" name="gender" class="w-full rounded-md border border-input bg-background px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 @error('gender') border-destructive @enderror">
                                    <option value="">Select Gender</option>
                                    <option value="male" {{ old('gender') === 'male' ? 'selected' : '' }}>Male</option>
                                    <option value="female" {{ old('gender') === 'female' ? 'selected' : '' }}>Female</option>
                                    <option value="other" {{ old('gender') === 'other' ? 'selected' : '' }}>Other</option>
                                </select>
                                @error('gender')<p class="text-xs text-destructive mt-1">{{ $message }}</p>@enderror
                            </div>
                            
                            <div class="space-y-1">
                                <label for="activity_level" class="text-sm font-medium">Activity Level</label>
                                <select id="activity_level" name="activity_level" class="w-full rounded-md border border-input bg-background px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 @error('activity_level') border-destructive @enderror">
                                ...
                                @error('activity_level')<p class="text-xs text-destructive mt-1">{{ $message }}</p>@enderror
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-1">
                                ...
                                <div class="flex gap-2">
                                    <input id="height" name="height" type="number" min="100" max="250" step="0.1" value="{{ old('height') }}" placeholder="170"
                                           class="flex-1 rounded-md border border-input bg-background px-3 py-2 text-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 @error('height') border-destructive @enderror">
                                    <select name="height_unit" class="w-16 rounded-md border border-input bg-background px-2 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
                                        ...
                                        <option value="ft" {{ old('height_unit') === 'ft' ? 'selected' : '' }}>ft</option>
                                    </select>
                                </div>
                                <p class="text-xs text-muted-foreground">Better nutrition recommendations</p>
                                @error('height')<p class="text-xs text-destructive mt-1">{{ $message }}</p>@enderror
                            </div>
                            
                            <div class="space-y-1">
                                <label for="weight" class="text-sm font-medium">Weight</label>
                                <div class="flex gap-2">
                                    <input id="weight" name="weight" type="number" min="30" max="300" step="0.1" value="{{ old('weight') }}" placeholder="70"
                                           class="flex-1 rounded-md border border-input bg-background px-3 py-2 text-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 @error('weight') border-destructive @enderror">
                                ...
                                @error('weight')<p class="text-xs text-destructive mt-1">{{ $message }}</p>@enderror
                            </div>
                        </div>
                    </div>
