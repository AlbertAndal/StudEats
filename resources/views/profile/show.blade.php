...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4">
        <div class="flex items-center justify-between mb-3">
            ...
            <span class="text-sm text-blue-700 font-medium">{{ round($completionPercentage) }}%</span>
        </div>
        ...
        <a href="{{ route('profile.edit') }}" class="inline-flex items-center mt-2 text-sm font-medium text-blue-600 hover:text-blue-500">
            Complete Profile
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-1">
                            ...
                            <p class="text-sm text-card-foreground font-medium">{{ $user->name }}</p>
                        </div>
                        <div class="space-y-1">
                            <label class="text-sm font-medium text-muted-foreground">Email Address</label>
                            <p class="text-sm text-card-foreground font-medium">{{ $user->email }}</p>
                        </div>
                        <div class="space-y-1">
                            <label class="text-sm font-medium text-muted-foreground">Age</label>
                            <p class="text-sm text-card-foreground font-medium">{{ $user->age ?? 'Not specified' }}</p>
                        </div>
                        <div class="space-y-1">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-1">
                            ...
                            <p class="text-sm text-card-foreground font-medium">{{ $user->gender ? ucfirst($user->gender) : 'Not specified' }}</p>
                        </div>
                        <div class="space-y-1">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-1">
                            ...
                            <p class="text-lg font-bold {{ $bmiColor }}">{{ number_format($bmi, 1) }}</p>
                            <p class="text-sm {{ $bmiColor }} font-medium">{{ $bmiCategory }}</p>
                        </div>
                        <div class="space-y-1">
                            <label class="text-sm font-medium text-muted-foreground">Estimated Daily Calories</label>
                            <p class="text-lg font-bold text-card-foreground">{{ number_format($estimatedCalories, 0) }}</p>
                ...
                <div class="p-6">
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <a href="{{ route('profile.edit') }}" class="mt-2 inline-flex items-center text-sm text-primary hover:text-primary/80">
                                Add preferences
                            </a>
                        </div>
                    @endif
