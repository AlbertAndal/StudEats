...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <form id="profile-form" action="{{ route('profile.update') }}" method="POST" class="space-y-8">
        @csrf
        @method('PUT')
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="name" name="name" required
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors @error('name') border-red-300 @enderror"
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="email" id="email" name="email" required
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors @error('email') border-red-300 @enderror"
                ...
                <div>
                    ...
                    <input type="number" id="age" name="age" min="13" max="120"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors @error('age') border-red-300 @enderror"
                ...
                <div>
                    ...
                    <select id="gender" name="gender"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors @error('gender') border-red-300 @enderror">
                ...
                <div class="md:col-span-2">
                    ...
                    <select id="timezone" name="timezone"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors @error('timezone') border-red-300 @enderror">
                        <option value="">Select your timezone</option>
                        <option value="Asia/Manila" {{ old('timezone', $user->timezone) == 'Asia/Manila' ? 'selected' : '' }}>Asia/Manila (Philippine Time)</option>
                ...
                <div>
                    ...
                    <div class="flex space-x-2">
                        <input type="number" id="height" name="height" min="100" max="250" step="0.1"
                               class="flex-1 px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors @error('height') border-red-300 @enderror"
                ...
                <div>
                    ...
                    <div class="flex space-x-2">
                        <input type="number" id="weight" name="weight" min="30" max="300" step="0.1"
                               class="flex-1 px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors @error('weight') border-red-300 @enderror"
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
                        ...
                        @foreach($activityLevels as $value => $info)
                            <label class="relative flex flex-col p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition-colors {{ old('activity_level', $user->activity_level) == $value ? 'bg-green-50 border-green-500' : 'border-gray-300' }}">
                                <input type="radio" name="activity_level" value="{{ $value }}" 
                                       class="sr-only peer"
                                       {{ old('activity_level', $user->activity_level) == $value ? 'checked' : '' }}>
                                <div class="text-sm font-medium text-gray-900 peer-checked:text-green-700">{{ $info[0] }}</div>
                                <div class="text-xs text-gray-500 peer-checked:text-green-600">{{ $info[1] }}</div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="daily_budget" name="daily_budget" min="100" max="2000" step="10"
                               class="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors @error('daily_budget') border-red-300 @enderror"
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                        ...
                        @foreach($preferences as $value => $info)
                            <label class="relative flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition-colors {{ in_array($value, old('dietary_preferences', $user->dietary_preferences ?? [])) ? 'bg-green-50 border-green-500' : 'border-gray-300' }}">
                                <input type="checkbox" name="dietary_preferences[]" value="{{ $value }}" 
                                       class="sr-only peer"
                                       {{ in_array($value, old('dietary_preferences', $user->dietary_preferences ?? [])) ? 'checked' : '' }}>
                                <div class="flex items-center space-x-2">
                                    <span class="text-lg">{{ $info[0] }}</span>
                                    <span class="text-sm font-medium text-gray-700 peer-checked:text-green-700">{{ $info[1] }}</span>
                                </div>
                                <div class="absolute inset-0 border-2 border-transparent peer-checked:border-green-500 rounded-lg pointer-events-none"></div>
                            </label>
                        @endforeach
